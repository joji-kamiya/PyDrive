...
class GoogleAuth(ApiAttributeMixin, object):
    ...
    SERVICE_CONFIGS_LIST = ['client_service_email', 'client_user_email',
                            'client_pkcs12_file_path', 'json_file_path']
    ...
    def ServiceAuth(self):
        ...
        json_file_path = self.client_config['json_file_path']
    ...
    def LoadClientConfigFile(self, client_config_file=None):
        ...
        try:
            ...
            # The service auth fields are not present, handling code can go here.
            pass
